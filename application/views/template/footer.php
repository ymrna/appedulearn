...
Edulearn adalah Web edukasi yang dilengkapi video, materi dan sistem ujian
yang tersedia secara gratis. Edulearn dibuat ditujukan agar para siswa dan
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Edulearn</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi Edulearn</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Edulearn</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Edulearn</h4>
                <p>
                    Web Edukasi Open Source. Edulern adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Edulearn dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Edulearn is made with <span class="text-danger"> &#10084;</span> 
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
