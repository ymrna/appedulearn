...
<head>
	...
	<title>Tentang Developer - Edulearn</title>
	<!-- General CSS Files -->
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - Edulearn</div>
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project Eduelarn </h1>
					</div>
					<div class="">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang Edulearn</h2>
								<hr>
								<p class="card-text">Web Edukasi Open Source <br> Edulearn adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> Edulearn dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
							</div>
						</div>
					</div>
				</section>
